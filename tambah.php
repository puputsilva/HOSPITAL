...
<html lang="en">
  ...
  <section
    ...
    <section>
        <h1 class="text-center">Tambah Data Rekam Medis</h1>
        <div class="container">
        <div class="col-md-6 offset-3">
            <form action="prosestambah.php" method="post">
                <label for="kd">Kode Pasien</label>
                <input type="number" name="kd" id="kd" class="form-control">
                <label for="nama">Nama Pasien</label>
                <input type="text" name="nama" id="nama" class="form-control">
                <label for="tgl">Tanggal Lahir Pasien</label>
                <input type="date" name="tgl" id="tgl" class="form-control">
                <label for="tl">Tempat Lahir Pasien</label>
                <input type="text" name="tl" id="tl" class="form-control">
                ...
                <input type="text" name="rincian" id="rincian" class="form-control">
