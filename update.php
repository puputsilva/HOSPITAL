...
<html lang="en">
  ...
  <section
    ...
    <section>
        <h1 class="text-center">Update Data Rekam Medis</h1>
        <?php
            include 'koneksi.php';
            $kd = $_GET['kd'];
            $data = mysqli_query($koneksi, "SELECT * FROM rumahsakit WHERE kd = '$kd'") or die(mysqli_error($koneksi));
            $baris = mysqli_fetch_array($data);
        ?>
        <div class="container">
        <div class="col-md-6 offset-3">
        <form action="prosesupdate.php?kd=<?php echo $kd; ?>" method="post">
            <label for="kd">Kode Pasien</label>
            <input type="number" class="form-control" name="kd" value="<?php echo $baris['kd']; ?>">
            <label for="nama">Nama Pasien</label>
            <input type="text" class="form-control" name="nama" value="<?php echo $baris['nama']; ?>">
            <label for="tgl">Tanggal Lahir</label>
            <input type="text" class="form-control" name="tgl" value="<?php echo $baris['tgl']; ?>">
            <label for="tl">Tempat Lahir Pasien</label>
            <input type="text" class="form-control" name="tl" value="<?php echo $baris['tl']; ?>">
            <label for="kelamin">Kelamin Pasien</label>
            <input type="text" class="form-control" name="kelamin" value="<?php echo $baris['kelamin']; ?>">
            <label for="alamat">Alamat</label>
            <input type="text" class="form-control" name="alamat" value="<?php echo $baris['alamat']; ?>">
            <label for="usia">Usia Pasien</label>
            <input type="text" class="form-control" name="usia" value="<?php echo $baris['usia']; ?>">
            <label for="penyakit">Penyakit Pasien</label>
            <input type="text" class="form-control" name="penyakit" value="<?php echo $baris['penyakit']; ?>">
            <label for="rincian">Rincian Pasien</label>
            <input type="text" class="form-control" name="rincian" value="<?php echo $baris['rincian']; ?>">
